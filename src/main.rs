...
mod test {
    ...
    fn test_glob() {
        ...
        assert_eq!(response.status(), Status::Ok);
        assert_eq!(response.into_string().unwrap(),"{\"paths_list\":[\"./samples\",\"./samples/aaa.002.tif\",\"./samples/aaa.005.tif\",\"./samples/aaa.001.tif\",\"./samples/aaa.004.tif\",\"./samples/aaa.003.tif\",\"./samples/bbb.001.exr\",\"./samples/subfolder\",\"./samples/subfolder/ccc.050.exr\"]}");
    }
}
